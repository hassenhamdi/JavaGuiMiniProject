...
public class Vehicule extends JFrame {
	...
	private void initComponents() {
		...
		}, new String[] { "Matricule", "Marque", "Modele", "Couleur", "Disponibilt�" }) {
	...
	private void addActionPerformed(ActionEvent evt) {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "La voiture a �t� enregistr�e avec succ�ss");
	...
	private void editActionPerformed(ActionEvent evt) {
		...
		try {
			...
			insert.executeUpdate();
			JOptionPane.showMessageDialog(this, "Le registre a �t� mis � jour");
